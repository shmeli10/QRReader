package com.ostin.qrreader.home.tabs.reader
...
import com.ostin.qrreader.databinding.FragmentReaderBinding
...
class ReaderFragment : Fragment(), CodeReaderInterface {
    private var binding: FragmentReaderBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        codeReader = CodeReader(appContext, this)
    }
    ...
    private fun setupAllowCameraPermBtn() {
        /*binding!!.allow_button.setOnClickListener {
    ...
    private fun disableAllowCameraPermBtn() {
        // binding!!.allow_button.setOnClickListener { null }
    }
